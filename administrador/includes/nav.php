 ...
 <div class="app-sidebar__overlay" data-toggle="sidebar"></div>
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="https://randomuser.me/api/portraits/men/1.jpg" alt="User Image">
        <div>
          <p class="app-sidebar__user-name">Eduin GG</p>
          <p class="app-sidebar__user-designation">ADMIN</p>
        </div>
      </div>
      <ul class="app-menu">
        <li><a class="app-menu__item" href="../administrador/index.php"><i class="app-menu__icon bi bi-speedometer"></i><span class="app-menu__label">Dashboard</span></a></li>
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon bi bi-laptop"></i><span class="app-menu__label"> Estadisticas </span><i class="treeview-indicator bi bi-chevron-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="/administrador/dasboard.php"><i class="icon bi bi-circle-fill"></i> Bootstrap Elements</a></li>
            ...
            <li><a class="treeview-item" href="jasja.html"><i class="icon bi bi-circle-fill"></i> Widgets</a></li>
          </ul>
        </li>
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon bi bi-table"></i><span class="app-menu__label">Calendario</span><i class="treeview-indicator bi bi-chevron-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="/adetriunf/administrador/calendario.php" class="icon bi bi-circle-fill"></i>Calendario </a></li>
          </ul>
        </li>
